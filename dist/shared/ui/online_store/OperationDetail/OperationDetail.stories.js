...
export const Default = {
    args: {
        ...
        category: 'Смартфоны',
        description: 'Флагманский смартфон с титановым корпусом, дисплеем Super Retina XDR и камерой 48 МП. ' +
...
export const NoImage = {
    args: {
        ...
        description: 'Полный курс по разработке на React с использованием TypeScript. ' +
...
export const LowPrice = {
    args: {
        ...
        description: 'Удобный блокнот формата A5 с белой бумагой и твёрдой обложкой. ' +
